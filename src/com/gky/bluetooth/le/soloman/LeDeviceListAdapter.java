...
public class LeDeviceListAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			viewHolder.device_list = (LinearLayout) view.findViewById(R.id.device_list);
...
//		if (i != 0) {
//			viewHolder.device_list.setVisibility(View.GONE);
//		}else {
//			viewHolder.device_list.setBackgroundResource(R.drawable.welcome);
//		}
